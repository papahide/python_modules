...
def main() -> None:
    ...
    capitalize_play: list[str] | None = [player for player in players if player[0].isupper()]
    ...
    players_scores = {play: random.randint(0, 1000) for play in capitalize_play}
    ...
    h_scores: dict[str, int] = {play: players_scores[play] for play in players_scores if players_scores[play] > avg}
